...
Hype is part of most marketing plans, creating a need for products and services - AI Hype likes comparing data with oil.  Making comparisons with other valuable resources implies great value in drilling for insight in the data.  If data is oil then at best it is expensive shale oil and at worst worthless snake oil.
...
This abundance belies the difficulty with Data.  If it is so freely available then why are machine learning solutions so difficult and expensive to implement?

The answer lies in the similarities with water.  What ML algorithms need is drinking water, and like drinking water, that's not what is freely available.  Sea water, dirty water, data polluted by our processing of it.

Solutions to clean structured data are analogous:
<div class='w3-card'>
...
<span class="w3-opacity" markdown="1">Photo By Jim Linwood - Rainwater Harvesting in Gibraltar - 1992.Uploaded by ecemaml, CC BY 2.0,[https://commons.wikimedia.org/w/index.php?curid=9526561](https://commons.wikimedia.org/w/index.php?curid=9526561)</span>
...
Scientific and Engineering applications offer the same benefits.  Sensors produce reliably structured data in the absence of faults.  None of this is true of our real world C2B and B2B interactions or transactions.  To reconstruct this interaction data from what data has been collected is a complex problem requiring sophisticated ML and inference.

Given the length of time technology provision takes in large firms, making the one low cost decision to collect data will likely show rewards before the grand drilling platform has been built.

There is no Return on Investment for this solution today, or tomorrow, but in a year, the collected data will allow solutions to problems that the business may not even be aware of today.
...
And all just for putting a bucket out. Start Today.


[Gibraltar Photo By Jim Linwood - Rainwater Harvesting in Gibraltar - 1992.Uploaded by ecemaml, CC BY 2.0,][https://commons.wikimedia.org/w/index.php?curid=9526561](https://commons.wikimedia.org/w/index.php?curid=9526561)